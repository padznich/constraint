...
problem.addVariable("r_1",
                    [{'sq': i['sq'], 'a': i['a'], 'b': i['b'], 'adjacent': 'r_4'} for i in rd_1[1:5]])
problem.addVariable("r_2",
                    [{'sq': i['sq'], 'a': i['a'], 'b': i['b'], 'adjacent': 'r_3'} for i in rd_2[1:5]])
problem.addVariable("r_3",
                    [{'sq': i['sq'], 'a': i['a'], 'b': i['b'], 'adjacent': ['r_2', 'r_4']} for i in rd_3[1:5]])
problem.addVariable("r_4",
                    [{'sq': i['sq'], 'a': i['a'], 'b': i['b'], 'adjacent': ['r_0', 'r_1', 'r_3']} for i in rd_4[1:5]])
problem.addVariable("r_5",
                    [{'sq': i['sq'], 'a': i['a'], 'b': i['b'], 'adjacent': ['r_4']} for i in rd_5[1:5]])


# assign constraint
# problem.addConstraint(lambda r_0: r_0['belong'] in ["r_4"], ['r_0'])
# problem.addConstraint(lambda r_1: r_1['belong'] in ["r_4"], ['r_1'])
# problem.addConstraint(lambda r_2: r_2['belong'] in ["r_3"], ['r_2'])
# problem.addConstraint(lambda r_3: all(r_3['belong']) in ["r_2", "r_4"], ['r_3'])
# problem.addConstraint(lambda r_4: all(r_4['belong']) in ["r_0", "r_1", "r_3"], ['r_4'])
...
# for sol in sorted(solutions)[solutions_number -105: solutions_number]:

with open('rooms_a_b.csv', 'w') as csvfile:
    fieldnames = ['r_0_a', 'r_0_b',
                  'r_1_a', 'r_1_b',
                  'r_2_a', 'r_2_b',
                  'r_3_a', 'r_3_b',
                  'r_4_a', 'r_4_b',
